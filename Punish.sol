...
contract Params {
    ...
    uint256 public minimumValidatorStaking = 4444444 ether;


    // percent distrubution of Gas Fee earned by validator 100000 = 100%
    uint public stakerPartPercent = 70000;          //70% 
    uint public validatorPartPercent = 10000;       //10%
    uint public burnPartPercent = 0;                //0%
    uint public contractPartPercent = 20000;        //20%
    uint public burnStopAmount = 100000000 ether;   // after 100M coins burn, it will stop burning
